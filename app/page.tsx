...
export default function HomePage() {
  ...
  return [];
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Choose CodeDuel?</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="text-lg font-semibold text-foreground">CodeDuel</span>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-border/40 text-center text-sm text-muted-foreground">
            © 2025 CodeDuel. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
